...
"[project]/lib/mongodb.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/models/User.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mongodb.ts [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/User.ts [middleware] (ecmascript)");
;
;
;
;
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["connectDB"])();
                const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["default"].findOne({
...
async function proxy(request) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["auth"])();
    const { pathname } = request.nextUrl;
    const isAuthRoute = pathname.startsWith('/login') || pathname.startsWith('/register');
    const isDashboardRoute = pathname.startsWith('/chat') || pathname.startsWith('/team') || pathname.startsWith('/settings');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__102x2jz._.js.map